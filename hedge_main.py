...
parser.add_argument('--out-file', type=str, default='hedge_interpretation_index.txt', help='path to save the final model')
...
def cal_acc_inter(model, data_iter, fileobject, win_size=2, device='cuda'):
    ...
    for batch in itertools.islice(data_iter, 5, 6):
        count += 1
        ...
        shap.visualize_tree(batch,wordvocab)
