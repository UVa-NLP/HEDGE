...
def evaluate(args, model, tokenizer, eval_dataset, fileobject, start_pos=0, end_pos=2000):
...
if __name__ == '__main__':
    ...
    with open(file_name, 'w') as f:
        test_loss, test_acc = evaluate(args, model, tokenizer, test_dataset, f, start_pos, end_pos)
